...
func fixtureStyle(t *testing.T, remoteGlyphs bool) []byte {
	t.Helper()
	...
	if remoteGlyphs { style["glyphs"]="https://external.test/{fontstack}/{range}.pbf" }
