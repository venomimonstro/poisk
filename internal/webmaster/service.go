...
type Store interface {
	...
	QueueSitemapSubmission(context.Context,int64,int64,string)(int64,error)
...
func (s *Service) Login(ctx context.Context,email,password string)(Session,error){
	...
	if err!=nil { _,_ = wmauth.HashPassword(password); return Session{},ErrUnauthorized }
...
func (s *Service) SubmitSitemap(ctx context.Context,userID,siteID int64,raw string)(int64,error){
	...
	return s.Store.QueueSitemapSubmission(ctx,userID,siteID,normalized)
}
